...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($form_errors)) {
        try {
            ...
            $form_errors['general'] = 'Error creating user. Please try again.';
        }
    }
}
?>
...
<div class="dashboard-container">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p>Create a new account for a student, teacher, or administrator</p>
            ...
            <form method="POST" action="" novalidate>
                ...
                <div class="form-group <?php echo isset($form_errors['role']) ? 'has-error' : ''; ?>">
                    ...
                    <select id="role" name="role" required>
                        ...
                        <option value="teacher" <?php echo ($role ?? 'student') === 'teacher' ? 'selected' : ''; ?>>
                            Teacher
                        </option>
                        <option value="admin" <?php echo ($role ?? 'student') === 'admin' ? 'selected' : ''; ?>>
                            Administrator
                        </option>
                    </select>
                    <div class="role-info">
...
document.getElementById('password').addEventListener('input', function() {
    ...
    if (/[A-Z]/.test(pwd)) requirements.push('✓ Uppercase letter');
    if (/[a-z]/.test(pwd)) requirements.push('✓ Lowercase letter');
    if (/\d/.test(pwd)) requirements.push('✓ Number');
    if (/[!@#$%^&*]/.test(pwd)) requirements.push('✓ Special character');
});
