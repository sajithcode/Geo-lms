...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="<?php echo ($currentPage == 'performance') ? 'active' : '' ?>"><a href="performance.php"><i class="fa-solid fa-chart-line"></i> Performance</a></li>
            <li class="<?php echo ($currentPage == 'interaction') ? 'active' : '' ?>"><a href="interaction.php"><i class="fa-solid fa-comments"></i> Interaction</a></li>
            ...
            <li class="<?php echo ($currentPage == 'feedback') ? 'active' : '' ?>"><a href="feedback.php"><i class="fa-solid fa-message"></i> Feedback</a></li>
            <li class="<?php echo ($currentPage == 'settings') ? 'active' : '' ?>"><a href="settings.php"><i class="fa-solid fa-cog"></i> Settings</a></li>
