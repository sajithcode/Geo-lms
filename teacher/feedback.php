...
if ($feedback_table_exists) {
    try {
        ...
        if (!empty($search_query)) {
            $sql .= " AND (f.message LIKE ? OR u.username LIKE ? OR u.full_name LIKE ?)";
...
<head>
    ...
    <title>Student Feedback - Teacher Portal</title>
    ...
    <main class="main-content">
        <div class="feedback-container">
            ...
            <div class="page-header">
                ...
                <p>Review and manage feedback submitted by students</p>
            </div>
                    ...
                    <div class="filters-row">
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" name="search" id="search" 
                                   placeholder="Search by message or student name..." 
